...
gnome-terminal -- bash -c "roslaunch rda_ros Town02_spawn_car.launch"
...
gnome-terminal -- bash -c "roslaunch rda_ros Town02_generate_traffic.launch"

sleep 6

# Step 4: Run rda_ros control
echo "Running RDA ROS control..."
gnome-terminal -- bash -c "roslaunch rda_ros Town02_rda_carla.launch"