...
gnome-terminal -- bash -c "roslaunch rda_ros run_carla_Town01.launch"
...
gnome-terminal -- bash -c "roslaunch rda_ros generate_traffic_Town01.launch"

sleep 6

# Step 4: Run rda_ros control
echo "Running RDA ROS control..."
gnome-terminal -- bash -c "roslaunch rda_ros rda_carla_Town01.launch"